...
var memoryRegistry registry.Registry
var once sync.Once
func GetRegistry(opts ...registry.Option) registry.Registry {
	once.Do(func() {
		if memoryRegistry  == nil{
			memoryRegistry = NewRegistry(opts...)
		}
	})
...
type Registry struct {
	...
	logger  log2.Interface
	sync.RWMutex
	records  map[string]map[string]*record
	watchers map[string]*Watcher
}

func (m *Registry) getLogger() log2.Interface {
	if m.logger != nil {
		return m.logger
	}
	return log2.Log
